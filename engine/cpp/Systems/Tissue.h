...
protected:
  ...
  // Load a state
  virtual bool Load(const CDM::PulseTissueSystemData& in);
  virtual CDM::PulseTissueSystemData* Unload() const;
protected:
  virtual void Unload(CDM::PulseTissueSystemData& data) const;
