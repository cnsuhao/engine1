...
class DLL_DECL HeatCapacitancePerAmountUnit : public CCompoundUnit
{
public:
...
class DLL_DECL SEScalarHeatCapacitancePerAmount : public SEScalarQuantity<HeatCapacitancePerAmountUnit>
{
public:
