...
class DLL_DECL VolumePerTimePressureAreaUnit : public CCompoundUnit
{
public:
...
class DLL_DECL SEScalarVolumePerTimePressureArea : public SEScalarQuantity<VolumePerTimePressureAreaUnit>
{
public:
