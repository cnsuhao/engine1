...
#include "bind/ScalarMassPerAreaTimeData.hxx"

class DLL_DECL MassPerAreaTimeUnit : public CCompoundUnit
{
public:
...
class DLL_DECL SEScalarMassPerAreaTime : public SEScalarQuantity<MassPerAreaTimeUnit>
{
public:
